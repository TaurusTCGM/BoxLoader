...
_veh addAction [localize "STR_boxloader_Load_flat",{
...
_veh addAction [localize "STR_boxloader_Unload_flat",{[_this select 0,objNull] call boxloader_fnc_pls;},[],1.5,false,true,"","(driver _target == _this) && !(isNull (_target getVariable ['boxloader_flatrack',objNull]))"];
true
